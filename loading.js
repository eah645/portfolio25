...
document.onreadystatechange = function () {
  ...
  if (document.readyState !== "complete") {
    const timeoutFirst = setTimeout(loadingLogo, 750);
    ...
    //It'd be great to make this fade in too but for now-
    const timeoutLast = setTimeout(letsEnd, 6200);
  }
};
...
function loadThePage() {
  ...
  document
    .getElementById("not-loading")
    .classList.remove("not-loading-initial");
}
